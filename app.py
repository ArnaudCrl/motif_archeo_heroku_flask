...
def predict_from_bytes(img_bytes):
    ...
    html_result =  """<p style="text-align: center;"><span style="color: rgb(97, 189, 109); font-size: 24px;">{}&nbsp;</span><span style="font-size: 24px;">{}</span></p>
                      <p style="text-align: center;"><span style="color: rgb(251, 160, 38); font-size: 20px;">{}&nbsp;</span><span style="font-size: 20px;">{}</span></p>
                      <p style="text-align: center;"><span style="color: rgb(184, 49, 47); font-size: 18px;">{}&nbsp;</span><span style="font-size: 18px;">{}</span></p>""".format(
